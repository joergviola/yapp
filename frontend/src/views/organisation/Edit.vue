<template>
  <div class="animated fadeIn">
    ...
    <row>
      <list icon="icon-user" label="Persons" type="user" with="organisation_id:organisation" cols="12" detail="/users/user/" :query="userQuery">
...
<script>
    ...
    export default {
      ...
      components: all,
      computed: {
          userQuery() { return 'organisation_id=' + this.$route.params.id },
      },
    }
</script>
